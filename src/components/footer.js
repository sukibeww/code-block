        ...
        <FooterContentWrapper>
          <FooterIntroWrapper>
            ...
            <h4 style={{ color: "white", margin: 0 }}>
              I am an Indonesian developer based in Jakarta, I love coding and
              experiment with design. I am currently invested in React and
              GraphQL. I created this blog to teach myself server-side rendering
              and search engine optimisation process, while trying to give
              blogging a shot at the same time.
            </h4>
          </FooterIntroWrapper>
          <FooterLinksWrapper>
            <a href="https://github.com/sukibeww" style={{ color: "white" }}>
              <LinkContainer>
                <FaGithub size="2.3em" />
                <h4 style={{ color: "white", margin: 0, width: "100%" }}>
                  Github
                </h4>
              </LinkContainer>
            </a>
            ...
            <a
              href="https://twitter.com/suki_aliong"
              style={{ color: "white" }}
            >
              <LinkContainer>
